...
echo "🧪 Simple Test AttendanceMachineController...\n\n";
...
try {
    ...
    echo "📋 STEP 3: Test machine creation...\n";
    ...
    echo "📋 STEP 6: Test machine users retrieval...\n";
    ...
    echo "📋 STEP 7: Test machine update...\n";
    ...
    echo "📋 STEP 8: Test dashboard data...\n";
    ...
    try {
        ...
        echo "⚠️  Dashboard data calculation failed: " . $e->getMessage() . "\n\n";
    }
    
    echo "📋 STEP 9: Test machine deletion...\n";
