...
class NationalHolidayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Validasi input - tabel tidak menggunakan soft delete
        $request->validate([
            'date' => 'required|date|unique:national_holidays,date', // Kembali ke validasi normal karena tidak ada soft delete
