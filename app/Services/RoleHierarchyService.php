...
{
    // Standard hierarchy (tidak berubah)
    ...
    {
        if (!$supervisorId) return true; // Boleh tidak punya supervisor
        ...
        if (!$supervisor) return true; // Standard manager, tidak ada circular reference
