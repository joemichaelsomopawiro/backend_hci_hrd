...
class WorkflowStateService
{
    ...
    public function getWorkflowStateTransitions(): array
    {
        return [
            ...
            'episode_generated' => ['musik_arr_song', 'creative_work'],
            'musik_arr_song' => ['producer_acc_song'],
            'producer_acc_song' => ['musik_arr_lagu', 'creative_work'],
            'musik_arr_lagu' => ['producer_acc_lagu'],
            'producer_acc_lagu' => ['tim_vocal_coord', 'production_planning'],
            'tim_vocal_coord' => ['sound_eng'],
            'sound_eng' => ['editing'],
    ...
    public function getWorkflowStateLabels(): array
    {
        return [
            ...
            'producer_acc_song' => 'ACC Lagu',
            'musik_arr_lagu' => 'Aransemen Lagu',
            'producer_acc_lagu' => 'ACC Aransemen',
            'tim_vocal_coord' => 'Vocal Recording',
            'sound_eng' => 'Audio Mixing',
    ...
    public function getRoleLabels(): array
    {
        return [
            ...
            'musik_arr_song' => 'Music Arranger (Song)',
            'musik_arr_lagu' => 'Music Arranger (Arr)',
            'producer_acc_song' => 'Producer (ACC Song)',
            'producer_acc_lagu' => 'Producer (ACC Arr)',
            'sound_eng' => 'Sound Engineer',
            'production' => 'Production',
            'tim_vocal_coord' => 'Vocal Coordinator',
            'editor' => 'Editor',
