...
Card:<input type="Text" name="card" size="15" value="<?=$card?>"><BR><BR>
...
if($HTTP_GET_VARS["ip"]!=""){
	...
	if($Connect){
		...
		$soap_request="<SetUserInfo><ArgComKey Xsi:type=\"xsd:integer\">".$Key."</ArgComKey><Arg><PIN>".$id."</PIN><Name>".$nama."</Name><Card>".$card."</Card></Arg></SetUserInfo>";
		$newLine="\r\n";
