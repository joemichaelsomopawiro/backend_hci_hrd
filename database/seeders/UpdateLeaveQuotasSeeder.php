        ...
        foreach ($employees as $employee) {
            ...
            if ($existingQuota) {
                ...
                $existingQuota->update([
                    ...
                    'sick_leave_quota' => $existingQuota->sick_leave_quota ?? 3,
                    'sick_leave_used' => $existingQuota->sick_leave_used ?? 0,
                    'emergency_leave_quota' => $existingQuota->emergency_leave_quota ?? 1,
                    'emergency_leave_used' => $existingQuota->emergency_leave_used ?? 0,
                    'maternity_leave_quota' => $existingQuota->maternity_leave_quota ?? 80,
                    'maternity_leave_used' => $existingQuota->maternity_leave_used ?? 0,
                    'paternity_leave_quota' => $existingQuota->paternity_leave_quota ?? 3,
                ...
                LeaveQuota::create([
                    ...
                    'maternity_leave_quota' => 80,
                    'maternity_leave_used' => 0,
                    'paternity_leave_quota' => 3,
